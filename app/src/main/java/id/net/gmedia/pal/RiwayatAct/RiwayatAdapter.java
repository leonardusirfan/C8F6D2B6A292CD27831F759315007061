...
public class RiwayatAdapter extends RecyclerView.Adapter<RiwayatAdapter.RiwayatViewHolder>{
    ...
    public RiwayatAdapter(Activity activity, List<NotaModel> listNota){
    ...
    public void onBindViewHolder(@NonNull RiwayatViewHolder riwayatViewHolder, int i) {
        final NotaModel m = listNota.get(i);
        ...
        if(activity instanceof ApprovalSo){
            ...
            riwayatViewHolder.item_riwayat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((ApprovalSo)activity).showApproval(m.getId());
                }
            });
