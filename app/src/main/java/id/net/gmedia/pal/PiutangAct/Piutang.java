...
public class Piutang extends AppCompatActivity {
    ...
    private void loadPiutang(final boolean init){
        ...
        /*for(int i = 0; i < listCustomer.size(); i++){
            total += listCustomer.get(i).getTotalPiutang();
        }
        ((TextView)findViewById(R.id.txt_total_piutang)).setText(Converter.doubleToRupiah(total));*/
    }
